...
def post_request(url, json_payload, **kwargs):
    try:
        resopose = requests.post(url, params=kwargs, json=json_payload)
        status_code = response.status_code
        print("With status {} ".format(status_code))
        json_data = json.loads(response.text)
        return json_data
...
def analyze_review_sentiments(text):
    url = "https://api.us-east.natural-language-understanding.watson.cloud.ibm.com/instances/24d3d75d-44c7-468e-9215-ce31e54fcc94"
    api_key = "sGP1QHG3_p7Sj5KQyk9m8uTif0lLzgSTAGcke7MJaYSi"
